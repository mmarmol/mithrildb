...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.IndexDefinition"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "model.IndexDefinition": {
            ...
            "properties": {
                "condition": {
                    "description": "Serialized expression (e.g., CEL, expr)",
                    "type": "string"
                },
                "created_at": {
                ...
                "last_updated_at": {
                    "description": "Last update applied",
                    "type": "integer"
                },
                "name": {
                    "description": "Must be CF-compatible",
                    "type": "string"
                },
                "projection": {
                    "description": "Fields used to build index key",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "total_indexed": {
                    "description": "Total keys indexed",
                    "type": "integer"
                }
            }
        },
